...
## 基本原则
### 文件命名
* 模板文件、静态资源（css,javascript）、图片等文件统一使用小写英文字母加下划线方式命名。
例如：twig模板文件  offering_show.html.twig  (模块名_动作或形容词.html.twig) 其他模板命名同理
...
<head>
	...
	<!-- 引入适配（必要文件，提前加载） -->
	<script src="/static/js/public/flexble_0.3.4.js"></script>
	<!-- 引入样式文件 -->
	<link rel="stylesheet" href="/static/css/moduler/style.css">
	</head>
</head>
<body>
...
